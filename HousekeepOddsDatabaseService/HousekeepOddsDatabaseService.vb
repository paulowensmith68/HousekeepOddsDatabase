...
Imports System.Text
Public Class HousekeepOddsDatabaseService
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        gobjEvent.WriteToEventLog("Service Start Banner:    *    HousekeepOddsDatabaseService STARTING    *")
        gobjEvent.WriteToEventLog("Service Start Banner:    ***********************************************")
...
Public Class Worker
    ...
    Public Sub StopWork()
        ...
        gobjEvent.WriteToEventLog("Service Stopping Banner: *       HousekeepOddsDatabaseService STOPPED             *")
        gobjEvent.WriteToEventLog("Service Stopping Banner: ************************************************")
